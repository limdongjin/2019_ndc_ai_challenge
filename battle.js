...
function battle() {
  ...
  for(i = 0; i < 100000; i++){
    ...
    for(var j = 0; j < 50; j ++) {
      ...
      const action_f = final.think(status.f_hp, status.f_mp, status.p_hp, status.p_mp, history_f_ai, oldgames_for_f_ai);
      // const action_p = random_ai(status.p_hp, status.p_mp, status.f_hp, status.f_mp, history_p_ai, oldgames_for_p_ai);
      const action_p = first_ai_prev.think(status.p_hp, status.p_mp, status.f_hp, status.f_mp, history_p_ai, oldgames_for_p_ai);
